...
df_combined = df_combined[df_combined['Start_Date'].dt.year == 2020]
...
fig = make_subplots(rows=2, cols=1, subplot_titles=("14-Day Average Total Bike Rides", "14-Day Average COVID-19 Cases"))
...
# Update layout
fig.update_layout(height=600, width=800, title_text="14-Day Rolling Averages: Bike Rides and COVID-19 Cases", showlegend=False)
